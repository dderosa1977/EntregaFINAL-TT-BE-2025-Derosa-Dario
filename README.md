...
3. Pruebas de Creación (método POST) (validaciones sobre ProductService. El Controller usa try-catch para esto)
...
4. Pruebas de Modificación/Edición (método PUT) (edición de todos los campos y la captura de errores. Usaremos un producto existente (ej: ID 2).
...
5. Pruebas de Eliminación (método DELETE)
